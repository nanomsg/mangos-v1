...
image:https://img.shields.io/badge/godoc-reference-blue.svg[GoDoc,link="https://godoc.org/nanomsg.org/go/mangos/v3"]
image:https://goreportcard.com/badge/nanomsg.org/go/mangos/v3[Go Report Card,link="https://goreportcard.com/report/nanomsg.org/go/mangos/v3"]
...
===  Using *go get*
    ...
    $ go get -u nanomsg.org/go/mangos/v3
...
For docs, see http://godoc.org/nanomsg.org/go-mangos or run:
    ...
    $ godoc nanomsg.org/go/mangos/v3
...
(Note that most of the tests are in a test subdirectory.)
    ...
    $ go test nanomsg.org/go/mangos/v3/...

There are also internal benchmarks available:

    $ go test -bench=. nanomsg.org/go/mangos/v3/test
